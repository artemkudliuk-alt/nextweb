...
export default function Footer() {
  ...
  // No-op useEffect for clean canvas removal
  useEffect(() => {
        ...
        >
          <div
            style={{
              height: "1.5px",
              width: "100%",
              background: "linear-gradient(90deg, #0e7490 0%, #581c87 50%, #881337 100%)",
              opacity: 0.35,
            }}
          />
        </div>
        ...
        <div className="footer-glass-layout">
          ...
          <div className="footer-glass-left">
            <h3 className="footer-brand-statement">
              Сложная веб-разработка,
              <br />
              дизайн на основе данных
              <br />и маркетинг в цифровой среде
            </h3>
            <span className="footer-brand-copyright footer-desktop-copyright">
              © NEXTWEB, 2009-2026
              <span className="footer-legal-inline">
                <Link to="/terms" className="footer-legal-link-inline">
                  Пользовательское соглашение
                </Link>
                <span className="footer-legal-divider">•</span>
                <Link to="/privacy" className="footer-legal-link-inline">
          ...
          <div className="footer-glass-right">
            <div className="footer-tags-group">
              ...
              <Link to="/about" className="footer-tag-pill">
                О НАС
              </Link>
              <Link to="/contacts" className="footer-tag-pill">
                КОНТАКТЫ
              </Link>
              <Link to="/reviews" className="footer-tag-pill">
                ОТЗЫВЫ
              </Link>
              <Link to="/partners" className="footer-tag-pill">
                ПАРТНЕРЫ
              </Link>
              <Link to="/blog" className="footer-tag-pill">
                БЛОГ
              </Link>
            </div>

            <div className="footer-contact-row">
              <a href="tel:+380487723543" className="footer-phone-large">
                048 772 35 43
              </a>
              <a href="mailto:office@nextweb.ua" className="footer-email-muted">
                OFFICE@NEXTWEB.UA
              </a>
            </div>
