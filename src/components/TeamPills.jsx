...
const initialPills = [
  ...
  { id: 2, name: 'UI/UX дизайнер', left: '88.89%', top: '25.95%', color: '#FF4D6D', driftDelay: '1.5s' },
  { id: 3, name: 'Бренд-дизайнер', left: '105%', top: '50%', color: '#FFB703', driftDelay: '3s' },
  { id: 4, name: 'Иллюстратор', left: '88.89%', top: '74.04%', color: '#06D6A0', driftDelay: '4.5s' },
  { id: 5, name: '3D дизайнер', left: '50%', top: '84%', color: '#8338EC', driftDelay: '2s' },
  { id: 6, name: 'Моушн-дизайнер', left: '11.1%', top: '74.04%', color: '#FF7B00', driftDelay: '3.5s' },
  { id: 7, name: 'Креативный директор', left: '-5%', top: '50%', color: '#EF233C', driftDelay: '0.8s' },
  { id: 8, name: 'Продуктовый дизайнер', left: '11.1%', top: '25.95%', color: '#FB6F92', driftDelay: '2.5s' }
];

export default function TeamPills() {
  const [pills, setPills] = useState(initialPills);
  const [dragState, setDragState] = useState({ id: null, startX: 0, startY: 0, origLeft: 0, origTop: 0 });
